...
class Arguments():
    def __init__(self):
        self.pgd = True
        self.detector = 0  # 2 means norm bound, 1 means krum and 0 nothing, 3 is GAN-based, 4 means opt_armor
        self.attack = 1  # 1 means random sampling, 3 means single shots 5 means no attack, 4 means model replacement
